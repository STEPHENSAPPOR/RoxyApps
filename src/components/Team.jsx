  ...
  return (
    <div className="flex flex-col items-center mt-10">
      ...
      <div className="w-full flex justify-center">
        <h2 className="text-2xl font-bold mb-4 border-b-2 border-gray-300 pb-2 w-full text-center">
          TEAM
        </h2>
      </div>
      ...
      <div className="flex justify-center space-x-4">
        {teamMembers.map((member, index) => (
          <div key={index} className="relative w-64 h-64">
            ...
            <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 hover:opacity-100 flex flex-col justify-center items-center text-white rounded-lg transition-opacity duration-300">
              <h2 className="text-xl font-bold text-[#FF9800]">{member.name}</h2>
